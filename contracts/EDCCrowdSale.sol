...
contract EDCCrowdSale is OwnedByICOOwner {
    ...
    constructor(address _EDC, address _contributionColdStorage,
                                uint256 _hardCap,
                                uint256 _startDate, uint256 _endDate) public {
        token = EDC(_EDC);             // initialising reference to ERC20
